...
DAUER_SEKUNDEN = 999999999       # Zeit bis zum automatischen Schließen
...
def beenden():
    """Schließt das Programm und löscht die Datei falls gewünscht"""
...
# Versteckter Button (unten rechts)
